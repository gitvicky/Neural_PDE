...
# -*- coding: utf-8 -*-
"""
FNO modelled over the 2D Navier-Stokes solving the KH instability equations auto-regressively 
...
run = Run(mode='online')
run.init(folder="/Neural_PDE", tags=['NPDE', 'FNO', 'Navier-Stokes', 'KH-Instability', 'Tests', 'AR'], metadata=configuration)
