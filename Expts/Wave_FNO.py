...
torch.save(model.state_dict(),  model_loc + '/' + configuration['Model'] + '_' + configuration['Case'] + run.name + '.pth')
...
pcm = ax.imshow(u_field[int(T_out/2),:,:], cmap=matplotlib.cm.coolwarm, extent=[9.5, 10.5, -0.5, 0.5], vmin=v_min_2, vmax=v_max_2)
