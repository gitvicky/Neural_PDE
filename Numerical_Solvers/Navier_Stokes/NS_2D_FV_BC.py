...
def main(N, boxsizeX, boxsizeY, gamma, courant_fac, tStart, tEnd, tOut, useSlopeLimiting, plotRealTime):
	...
	while t < tEnd:
		...
		# get Primitive variables
		rho, vx, vy, P = getPrimitive( Mass, Momx, Momy, Energy, gamma, vol )	
		rhorho.append(rho.T), uu.append(vx.T), vv.append(vy.T), pp.append(P.T)
...
# Simulation parameters
    ...
    rho, uu, vv, pp, dx, dtt = main(N, boxsizeX, boxsizeY, gamma, courant_fac, tStart, tEnd, tOut, useSlopeLimiting, plotRealTime)
    dt = dtt[0]*tOut
